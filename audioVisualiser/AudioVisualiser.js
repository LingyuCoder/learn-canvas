require(['LinePainter', 'BarPainter', 'SnowPainter', 'SpreadPainter', 'AudioBehavior', 'Item', 'Util'],
    function(LinePainter, BarPainter, SnowPainter, SpreadPainter, AudioBehavior, Item, Util) {
        'use strict';
